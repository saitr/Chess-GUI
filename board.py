...
class ChessBoard:
    ...
    def computeMove(self, givenMove):
        ...
        if givenMove[4] == "P" or givenMove[4] == "C":
            ...
            self.boardArray[int(givenMove[2])][int(
                givenMove[3])] = self.boardArray[int(givenMove[0])][int(givenMove[1])]
    ...
    def uncomputeMove(self, givenMove):
        ...
        if givenMove[4] == "P" or givenMove[4] == "C":
            ...
            self.boardArray[int(givenMove[0])][int(
                givenMove[1])] = self.boardArray[int(givenMove[2])][int(givenMove[3])]
            self.boardArray[int(givenMove[2])][int(
                givenMove[3])] = givenMove[4]
    ...
    def alphaBeta(self, depth, beta, alpha, givenMove, maxPlayer):
        ...
        for i in range(0, len(moveslist), 5):
            ...
            nextNode = self.alphaBeta(
                depth-1, beta, alpha, moveslist[i:(i+5)], maxPlayer)
    ...
    def changePerspective(self):
        ...
        for index in range(32):
            ...
            if self.boardArray[7-row][7-column].isupper():
                self.boardArray[row][column] = self.boardArray[7 -
                                                               row][7-column].lower()
            else:
                self.boardArray[row][column] = self.boardArray[7 -
                                                               row][7-column].upper()
